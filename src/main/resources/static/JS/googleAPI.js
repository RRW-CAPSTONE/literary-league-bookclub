...
function searchBooks(searchTerm) {
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              ...
                              <div class="position-absolute bottom-0 end-0">
                                 ...
                                 <a href="#" class="btn mt-auto top-nav-bg" data-bs-toggle="modal" data-bs-target="#book-modal" data-title="${title}" data-author="${authors}" data-description="${description}" data-thumbnail-url="${thumbnail}">Add Book</a>
                              </div>
                           </div>
                        </div>
                    </div>
    ...
    $('#book-modal').on('show.bs.modal', function(event) {
        ...
        $(this).find('.modal-author').text("By: " + author);
